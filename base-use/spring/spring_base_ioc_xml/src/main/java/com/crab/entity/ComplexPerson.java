...
public class ComplexPerson {
    ...
    public ComplexPerson(int id, String name, int age, String gender) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.gender = gender;
    ...
    public ComplexPerson(int id, String name, int age) {
        this.id = id;
        this.name = name;
        this.age = age;
    }

    public ComplexPerson(int id, String name, String gender) {
        this.id = id;
        this.name = name;
        this.gender = gender;
    }
